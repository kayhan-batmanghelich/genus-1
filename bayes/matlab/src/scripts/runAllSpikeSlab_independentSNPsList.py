...
inFn='/data/vision/polina/projects/ADNI/work/kayhan/Journal/MATLAB_Data/independentSNPs-ChrAll_Data94.mat'
outRoot='/data/vision/polina/users/kayhan/Experiments/DPP/geneticResults/SpikeSlabResults_independentSNPsList'
csvFile='/data/vision/polina/users/kayhan/Experiments/DPP/geneticResults/SpikeSlabResults_independentSNPsList/BFResultsFileList.csv'
#step='BF'
#step='normalize'
step='fxvb'
