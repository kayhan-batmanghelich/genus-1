...
inFn='/data/vision/polina/projects/ADNI/work/kayhan/Journal/MATLAB_Data/unimputedLowPVal-ChrAll_Data94.mat'
outRoot='/data/vision/polina/users/kayhan/Experiments/DPP/geneticResults/SpikeSlabResults_unimputedLowPVal0'
csvFile='/data/vision/polina/users/kayhan/Experiments/DPP/geneticResults/SpikeSlabResults_unimputedLowPVal0/BFResultsFileList.csv'
#step='BF'
#step='normalize'
step='fxvb'
